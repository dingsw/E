				...
				<table width="99%" border="0" cellspacing="5" cellpadding="5">
					...
					<tr>
						...
						<td>
							...
							<a href="GoodsServlet?method=3&goodId=${onegoods.id}" target="_blank">
							<img src="images/goods/${onegoods.goods_picture}" width="90" height="75" style="border:0" title="单击查看商品详细信息" onclick="addbrowsegoods()">
							</a><br>
						   	</div>	
