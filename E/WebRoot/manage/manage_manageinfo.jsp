				...
				<form name="manage_userInfo" method="post"  >
					  <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					   ...
					   <td><input type="text" name="account" value="${gb.id}" /></td>
					    ...
					    <td height="34" align="center"><a href="ManageServlet?method=manage_managedelete" >删除</a></td>
					    
					    </tr>
					    </c:if>
				        </c:forEach>
				        <tr>
				        <td height="34" align="center"><a href="manage_manageadd.jsp" >添加</a></td>
				        </tr>
					  </table>
				</form>
			 <br />
