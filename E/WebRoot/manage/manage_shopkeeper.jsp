				...
				<form name="manage_userInfo" method="post"  >
					  ...
					  <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					   ...
					   <tr>
					    ...
					    <td><input type="text" name="account" value="${gb.shop_id}" /></td>
					    <td height="34" align="left"><a href="ManageServlet?method=manage_shopkeeperdelete&id=${gb.id}" >删除</a></td>
					    </tr>
					    </c:if>
				        </c:forEach>
					  </table>
