        	   ...
        	   <blockquote>
				...
				<form name="manage_userInfo" method="post"  >
					  <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					    <!-- 循环输出留言信息 -->
                        <c:forEach items="${pageModel.list}" var="gb">
				        <c:if test="${!empty gb}">
					   <tr>
					    ...
					    <td><input type="text" name="account" value="${gb.number}" /></td>
					    ...
					    <td><input type="text" name="account" value="${gb.problem}" /></td>
					    <td><input type="text" name="account" value="${gb.answer}" /></td>
					    <td><input type="text" name="account" value="${gb.flag}" /></td>
