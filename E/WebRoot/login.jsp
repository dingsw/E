...
<c:if test="${empty sessionScope.userBean }">
	<form name="form" method="post" action="UserServlet?method=1" onSubmit="return checkEmpty(form)">
...
<c:if test="${!empty sessionScope.userBean }">
	<table width="230" border="0" align="center">
		<tr>
			...
			<td>  ${sessionScope.userBean.account}  </td>
		</tr>
		<tr>
		...
		<tr>
			<td height="20">  &nbsp;  </td>
			<td>  <a href="UserServlet?method=5" class="a2">重新登录</a>  </td>
		</tr>
	</table>
</c:if>
